...
namespace DamagePayee.Controllers
{
    public class DamagePayeeRegisterController : BaseController
    {
        ...
        public bool CheckMimeType(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            //   string fullpath = string.Empty;
            ...
            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:ShowCauseNotice").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                string FileName = Guid.NewGuid().ToString() + "_" + files.FileName;
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:ShowCauseNotice").Value.ToString();
        ...
        public bool CheckMimeType1(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;           
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:FGForm").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:FGForm").Value.ToString();
        ...
        public bool CheckMimeType2(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:Bill").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:Bill").Value.ToString();
        ...
        public bool CheckMimeType3(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:ATS").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:ATS").Value.ToString();
        ...
        public bool CheckMimeType4(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:GPA").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:GPA").Value.ToString();
        ...
        public bool CheckMimeType5(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:Mutation").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:Mutation").Value.ToString();
        ...
        public bool CheckMimeType6(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;
        ...
        public bool CheckMimeType7(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:AadharNoDocument").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:AadharNoDocument").Value.ToString();
        ...
        public bool CheckMimeType8(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:ATSGPADocument").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:ATSGPADocument").Value.ToString();
        ...
        public bool CheckMimeType9(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:RecieptDocument").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:RecieptDocument").Value.ToString();
        ...
        public bool CheckMimeType10(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:DamagePayeeFiles").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:DamagePayeeFiles").Value.ToString();
        ...
        public bool CheckMimeType11(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;
        ...
        public bool CheckMimeType12(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:OtherDocument").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:OtherDocument").Value.ToString();
        ...
        public bool CheckMimeType13(Damagepayeeregister damagepayeeregister)
        {
            bool Flag = true;
            string fullpath = string.Empty;
            string extension = string.Empty;

            DocumentFilePath = _configuration.GetSection("FilePaths:DamagePayeeFiles:PropertyPhotograph").Value.ToString();
            IFormFile files = damagepayeeregister.ShowCauseNotice;
            if (files != null)
            {
                extension = System.IO.Path.GetExtension(files.FileName);
                    ...
                    try
                    {
                        if (extension.ToLower() == ".pdf")
                        {
                            try
                            {
                                ...
                                iTextSharp.text.pdf.PdfReader oPdfReader = new iTextSharp.text.pdf.PdfReader(FilePath);
                                oPdfReader.Close();
                                fullpath = _configuration.GetSection("FilePaths:DamagePayeeFiles:PropertyPhotograph").Value.ToString();
