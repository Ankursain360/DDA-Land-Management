...
function GetExcel(pageNumber, pageSize, order) {
    ...
    HttpPost(`/NewLandDemandListDetails/DemanddetailsList`, 'html', param, function (response) {
        var a = document.createElement("a");
        a.target = '_blank';
        a.href = '/NewLandDemandListDetails/download';
        a.click();
    });
}
...
function GetDetails(pageNumber, pageSize) {
    ...
    HttpPost(`/NewLandDemandListDetails/List`, 'html', param, function (response) {
        $('#divTable').html("");
