...
function GetExcel(pageNumber, pageSize, order) {
    ...
    HttpPost(`/NewlandPossesionDetails/NewLandPossessionDetailsList`, 'html', param, function (response) {
        var a = document.createElement("a");
        a.target = '_blank';
        a.href = '/NewlandPossesionDetails/download';
        a.click();
    });
}
...
function GetDivision(pageNumber, pageSize, order) {
    var param = GetSearchParam(pageNumber, pageSize, order);
    HttpPost(`/NewlandPossesionDetails/List`, 'html', param, function (response) {
