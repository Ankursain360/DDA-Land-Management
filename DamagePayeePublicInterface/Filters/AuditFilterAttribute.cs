...
namespace DamagePayeePublicInterface.Filters
{
    public class AuditFilterAttribute  : ActionFilterAttribute
    {
        ...
        public AuditFilterAttribute( IAuditService auditService ,ISiteContext siteContext , IHttpContextAccessor httpContextAccessor)    
        {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            try
            {
                ...
                objaudit.Area = "Damage Payee Public Interface";
