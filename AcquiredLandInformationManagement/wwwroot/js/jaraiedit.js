...
function FillLesseeAtEdit() {
    ...
    HttpGet(`/JaraiDetails/GetDetailslesssee/?Id=${$("#Id").val() == null ? "" : $("#Id").val()}`, 'json', function (data) {
        debugger
        for (var i = 0; i < data.length; i++) {
            $("#tbl_posts1 #add1 #LesseeName").val(data[i].lesseeName);
            $("#tbl_posts1 #add1 #Father").val(data[i].fatherName);
            $("#tbl_posts1 #add1 #LAddress").val(data[i].address);
            $("#tbl_posts1 #add1 #Mortgage").val(data[i].mortgageDetails);
            if (i < data.length - 1) {
...
function FillFarmerAtEdit() {


    HttpGet(`/JaraiDetails/GetDetailsFarmer/?Id=${$("#Id").val() == null ? "" : $("#Id").val()}`, 'json', function (data) {
        debugger
        for (var i = 0; i < data.length; i++) {
            $("#tbl_posts2 #add2 #FarmerName").val(data[i].farmerName);
            $("#tbl_posts2 #add2 #FFatherName").val(data[i].fatherName);
            $("#tbl_posts2 #add2 #FAddress").val(data[i].address);
