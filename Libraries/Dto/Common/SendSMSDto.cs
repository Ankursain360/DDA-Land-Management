  ...
  public  class SendSMSDto
    {
        ...
        public void GenerateSendSMSForVerifyProperty(string PrimaryListNo, string Mobile)
        {
            ...
            string url = "http://gateway.leewaysoftech.com/xml-transconnect-api.php?username=Ddauth&password=m1kw6vu2&mobile=" + Mobile + "&message=You%20have%20successfully%20verified%20and%20added%20the%20record%20having%20Primary%20List%20no%20"+PrimaryListNo+"%20in%20Land%20Inventory.%20Land%20Management%20DDA&senderid=DDASVY&peid=1201159308150125712&contentid=1607100000000189083";
            HttpWebRequest httpreq = (HttpWebRequest)WebRequest.Create(url);
            try
            {
                HttpWebResponse httpres = (HttpWebResponse)httpreq.GetResponse();
        ...
        public void GenerateSendSMSForSaveEncroachmentRegistration(string RefNo, string Mobile)
        {
            ...
            string url = "http://gateway.leewaysoftech.com/xml-transconnect-api.php?username=Ddauth&password=m1kw6vu2&mobile=" + Mobile + "&message=Your%20inspection%20request%20containing%20inspection%20report%20vide%20Reference%20no%20"+RefNo+ "%20has%20been%20successfully%20submitted%20and%20forwarded%20for%20approval%20to%20your%20reporting%20officer.%20Land%20Management%20DDA%0A&senderid=DDASVY&peid=1201159308150125712&contentid=1607100000000189081";
            HttpWebRequest httpreq = (HttpWebRequest)WebRequest.Create(url);
            try
            {
                HttpWebResponse httpres = (HttpWebResponse)httpreq.GetResponse();
