...
{
    public class NewlandkhasraRepository : GenericRepository<Khasra>, IKhasraRepository
    {
        public NewlandkhasraRepository(DataContext dbContext) : base(dbContext)
        {

        }
        //public async Task<PagedResult<Newlandkhasra>> GetPagedKhasra(KhasraMasterSearchDto model)
        //{
        ...
        Task<PagedResult<Khasra>> IKhasraRepository.GetPagedKhasra(KhasraMasterSearchDto model)
        {
            throw new NotImplementedException();
        }

        public Task<PagedResult<Khasra>> GetPagedVillageKhasraReport(VillageDetailsKhasraWiseReportSearchDto model)
        {
            throw new NotImplementedException();
        }
    }
