...
namespace Libraries.Repository.EntityRepository
{
    ...
    public class LicenceFeesRepository : GenericRepository<Licencefees>, ILicenceFeesRepository
    {
        ...
        {
            var data = await _dbContext.Licencefees.Include(x => x.PropertyType)
        ...
        {
            return await _dbContext.Licencefees.Include(x => x.PropertyType).Where(x => x.IsActive == 1).ToListAsync();
        }
