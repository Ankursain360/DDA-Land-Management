...
{
    public class NoticeGenerationRepository : GenericRepository<Leasenoticegeneration>, INoticeGenerationRepository
    {

        public NoticeGenerationRepository(DataContext dbContext) : base(dbContext)
        {
