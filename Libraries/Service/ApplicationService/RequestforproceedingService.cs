...
{
    public class RequestforproceedingService : EntityService<Requestforproceeding>, IRequestforproceedingService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IRequestforproceedingRepository _requestRepository;

        public RequestforproceedingService(IUnitOfWork unitOfWork, IRequestforproceedingRepository requestRepository)
