...
{
    public class MutationOriginalOwnerTempConfiguration : IEntityTypeConfiguration<Mutationoriginalownertemp>
    {
        public void Configure(EntityTypeBuilder<Mutationoriginalownertemp> builder)
        {
            //builder.ToTable("mutationoriginalownertemp", "lms");

            builder.HasIndex(e => e.MutationId)
                .HasName("MutationOriginalTempId_idx");
            ...
            builder.HasOne(d => d.Mutation)
                .WithMany(p => p.Mutationoriginalownertemp)
                .HasForeignKey(d => d.MutationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("MutationOriginalTempId");
        }
    }
}
