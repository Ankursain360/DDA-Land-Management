...
{
    class AllottetypetempConfiguration : IEntityTypeConfiguration<Allottetypetemp>
    {
        public void Configure(EntityTypeBuilder<Allottetypetemp> builder)
        {
            builder.ToTable("allottetypetemp", "lms");
