...
{
    public class MutationNewOwnerTempConfiguration : IEntityTypeConfiguration<Mutationnewownertemp>
    {
        public void Configure(EntityTypeBuilder<Mutationnewownertemp> builder)
        {
            builder.ToTable("mutationnewownertemp", "lms");
            ...
            builder.HasOne(d => d.Mutation)
                .WithMany(p => p.Mutationnewownertemp)
                .HasForeignKey(d => d.MutationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("MutationNewTempId");
        }
    }
}
