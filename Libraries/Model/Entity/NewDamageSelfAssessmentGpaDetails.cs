...
namespace Libraries.Model.Entity
{
    public class NewDamageSelfAssessmentGpaDetails : AuditableEntity<int>
    {
        ...
        //public List<SelfAssessmentForm> SelfAssessmentFormList { get; set; }
        //public SelfAssessmentForm GetSelfAssessmentForm { get; set; }
        ...
        //[NotMapped]
        //public List<NewDamageSelfAssessment> NewDamageSelfAssessmentsList { get; set; }
