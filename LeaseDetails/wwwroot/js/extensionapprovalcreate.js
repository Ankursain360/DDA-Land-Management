...
function GetOtherDetails(id) {
    HttpGet(`/ExtensionApproval/ExtensionView/?Id=${id}`, 'html', function (response) {
        $('#ExtensionDetailsDiv').html("");
        $('#ExtensionDetailsDiv').html(response);
    });
};

function GetHistoryDetails(id) {
    HttpGet(`/ExtensionApproval/HistoryDetails/?Id=${id}`, 'html', function (response) {
...
function GetApprvoalStatus(id) {
    debugger;
    HttpGet(`/ExtensionApproval/GetApprvoalStatus/?value=${id}`, 'json', function (response) {
        if (response != null) {
...
function GetUserList(id) {
    debugger;
    HttpGet(`/ExtensionApproval/GetUserList/?value=${id}`, 'json', function (response) {
...
function GetForwardedUserList() {
    debugger;
    HttpGet(`/ExtensionApproval/GetForwardedUserList/?value=${parseInt($("#Id").val())}`, 'json', function (response) {
        if (response != null) {
            if (response[0] == "false") {
