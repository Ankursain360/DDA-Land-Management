...
namespace EncroachmentDemolition.Controllers
{
    public class DemolitionstructuredetailsController : BaseController
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            demolitionstructuredetails.StructureList = await _demolitionstructuredetailsService.GetAllStructure();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result)
                {
                    ...
                    if (demolitionstructuredetails.Date1 != null &&
                        demolitionstructuredetails.StructrureId != null)

                    {
                        if (demolitionstructuredetails.StructrureId.Count > 0 )

                        {
                            ...
                            for (int i = 0; i < demolitionstructuredetails.StructrureId.Count; i++)
                            {
                                rpt1.Add(new Demolishedstructurerpt
                                {
                                    ...
                                    StructureId = demolitionstructuredetails.StructureId.Count <= i ? null : demolitionstructuredetails.StructureId[i],
