...
namespace EncroachmentDemolition.Controllers
{
    public class DemolitionstructuredetailsController : BaseController
    {
        ...
        public async Task<PartialViewResult> List1([FromBody] DemolitionstructuredetailsDto1 model)
        {
            ...
            var result = await _demolitionstructuredetailsService.GetPagedDemolitiondiary(model, SiteContext.UserId, (int)ApprovalActionStatus.Approved, SiteContext.ZoneId ?? 0, SiteContext.DepartmentId ?? 0,SiteContext.RoleId??0);
