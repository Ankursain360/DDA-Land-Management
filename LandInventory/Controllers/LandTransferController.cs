...
namespace LandInventory.Controllers
{
    public class LandTransferController : BaseController
    {
        ...
        public virtual IActionResult download()
        {
            ...
            return File(data, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "HandoverTakeover.xlsx");
        ...
        public virtual IActionResult download1() 
        {
            ...
            HttpContext.Session.Remove("file");
            //byte[] data = TempData["file"] as byte[];
            return File(data, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "UnverifiedTransferRecords.xlsx");
