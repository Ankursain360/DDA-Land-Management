...
namespace AuthServer
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = "server=127.0.0.1;port=3306;user=root;password=123456;database=authserver";
            string lmsConnection = "server=127.0.0.1;port=3306;user=root;password=123456;database=lms";
